...
def añadeRegistos():
   ...
   # crear estudiantes
   estudiante1 = Estudiante ( apellidoPaterno = "qq" , apellidoMaterno = "Ortega" , nombres = "Juan Carlos" ,
                              elegible = True )
   estudiante2 = Estudiante ( apellidoPaterno = "ww" , apellidoMaterno = "Matos" , nombres = "Pedro" ,
                              elegible = True )
   estudiante3 = Estudiante ( apellidoPaterno = "ee" , apellidoMaterno = "Torres" , nombres = "Luis Alberto" ,
                              elegible = True )
   estudiante4 = Estudiante ( apellidoPaterno = "rr" , apellidoMaterno = "Mateo" , nombres = "Miguel Angel" ,
                              elegible = True )
   ...
   # crear asignatura
   asignatura1 = Asignatura ( nombreAsignatura = "Hello1" )
   asignatura2 = Asignatura ( nombreAsignatura = "Hello2" )
   session.add ( asignatura1 )
   session.add ( asignatura2 )
   session.commit ( )

   # crear equipo de trabajo
   equipo1 = Equipo( denominacionEquipo = "Equipo0A" )
   equipo2 = Equipo( denominacionEquipo = "Equipo0B"  )
   session.add ( equipo1 )
   session.add ( equipo2 )
   session.commit ( )

   # crear actividad
   actividad1 = Actividad ( denominacionActividad = "Ayuda1",fecha=datetime(2021, 9, 28, 00, 00, 00, 00000) )
   actividad2 = Actividad ( denominacionActividad = "Ayuda2",fecha=datetime(2021, 9, 25, 00, 00, 00, 00000) )
   actividad3 = Actividad ( denominacionActividad = "Ayuda3" , fecha = datetime ( 2021 , 9 , 25 , 00 , 00 , 00 , 00000 ) )
